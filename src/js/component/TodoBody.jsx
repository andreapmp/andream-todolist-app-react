...
const TodoBody = ({todos, setTodos}) => {
    ...
    // the dependency array is used to determine how the browser will rerender info

    useEffect(() => {
        fetch('https://playground.4geeks.com/todo/users/andream')
    ...
    // Delete a task from the playground
